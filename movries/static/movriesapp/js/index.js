...
// });
//
// При изменении слайда добавляем класс is-center к центральному элементу
...
//   $('.gallery-cell').removeClass('is-center');
//   $('.gallery-cell').eq(index).addClass('is-center');
// });
